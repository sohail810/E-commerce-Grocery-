    ...
    return (
        <div className=" pt-16 px-6 md:px-16 lg:px-24 xl:px-32">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    <h1 className='text-orange-500 font-semibold text-3xl tracking-widest uppercase sm:text-3xl'>A.S Mart</h1>
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
                Copyright 2026 © <a href="https://vishmart.com">A.S Mart</a> All Right Reserved.
            </p>
        </div>
    );
};
